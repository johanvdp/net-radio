...
typedef struct spi_ram_config_t {
...
typedef struct spi_ram_t *spi_ram_handle_t;
...
/**
 * @brief end data transactions
 * @param handle SPI RAM handle
 */
void spi_ram_end_data(spi_ram_handle_t handle);

/**
 * @brief Begin command transactions
 * Always _end every _begin.
 * @param handle SPI RAM handle
 */
...
/**
 * @brief end command transactions
 * @param handle SPI RAM handle
 */
